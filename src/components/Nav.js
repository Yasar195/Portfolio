...
const Nav = () => {
    return(
        <div className="w-full h-20 flex sticky top-0 z-10 bg-white dark:bg-slate-900 px-2 lg:px-6">
            ...
            <div className="nav invisible lg:visible w-2/4 h-full flex flex-col lg:flex-row items-center justify-start p-4 text-secondarytext dark:text-secondarytextdark flex items-center justify-evenly text-xl transition">
